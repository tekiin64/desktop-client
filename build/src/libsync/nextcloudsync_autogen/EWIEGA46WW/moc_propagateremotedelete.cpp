...
struct qt_meta_stringdata_CLASSOCCSCOPEPropagateRemoteDeleteENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSOCCSCOPEPropagateRemoteDeleteENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSOCCSCOPEPropagateRemoteDeleteENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject OCC::PropagateRemoteDelete::staticMetaObject = { {
    QMetaObject::SuperData::link<PropagateItemJob::staticMetaObject>(),
    qt_meta_stringdata_CLASSOCCSCOPEPropagateRemoteDeleteENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSOCCSCOPEPropagateRemoteDeleteENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSOCCSCOPEPropagateRemoteDeleteENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PropagateRemoteDelete, std::true_type>,
...
void *OCC::PropagateRemoteDelete::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSOCCSCOPEPropagateRemoteDeleteENDCLASS.stringdata0))
