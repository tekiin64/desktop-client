...
struct qt_meta_stringdata_CLASSOCCSCOPELockFileJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSOCCSCOPELockFileJobENDCLASS = QtMocHelpers::stringData(
    "OCC::LockFileJob",
    "finishedWithError",
    "",
    "httpErrorCode",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSOCCSCOPELockFileJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject OCC::LockFileJob::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractNetworkJob::staticMetaObject>(),
    qt_meta_stringdata_CLASSOCCSCOPELockFileJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSOCCSCOPELockFileJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSOCCSCOPELockFileJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<LockFileJob, std::true_type>,
...
void OCC::LockFileJob::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->finishedWithError((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LockFileJob::finishedWithError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &LockFileJob::finishedWithoutError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *OCC::LockFileJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSOCCSCOPELockFileJobENDCLASS.stringdata0))
