...
struct qt_meta_stringdata_CLASSOCCSCOPEOcsJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSOCCSCOPEOcsJobENDCLASS = QtMocHelpers::stringData(
    "OCC::OcsJob",
    "jobFinished",
    "",
    "reply",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSOCCSCOPEOcsJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject OCC::OcsJob::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractNetworkJob::staticMetaObject>(),
    qt_meta_stringdata_CLASSOCCSCOPEOcsJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSOCCSCOPEOcsJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSOCCSCOPEOcsJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<OcsJob, std::true_type>,
        // method 'jobFinished'
...
void OCC::OcsJob::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->jobFinished((*reinterpret_cast< std::add_pointer_t<QJsonDocument>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: _t->ocsError((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 2: _t->etagResponseHeaderReceived((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &OcsJob::jobFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &OcsJob::ocsError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &OcsJob::etagResponseHeaderReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *OCC::OcsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSOCCSCOPEOcsJobENDCLASS.stringdata0))
